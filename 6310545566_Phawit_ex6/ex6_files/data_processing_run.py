...
print()
print(dp.number_married_women_embarked("Southampton", 20, dp.titanic_data))
print(dp.number_married_women_embarked("Cherbourg", 15, dp.titanic_data))
print(dp.number_married_women_embarked("Queenstown", 30, dp.titanic_data))
print(dp.number_married_women_embarked("Southampton", 37, dp.titanic_data))
print(dp.number_married_women_embarked("Queenstown", 42, dp.titanic_data))
print()
